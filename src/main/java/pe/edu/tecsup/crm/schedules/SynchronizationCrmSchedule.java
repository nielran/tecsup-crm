...
//            // FALTA 2 MÁS ....
            ...
            for(ObjRequest inscripcion : inscripciones){
                try {
                    ...
                    messages.add("OK: [" + inscripcion.getStrIdCursoTecsup().getValue() + ":" + inscripcion.getStrNumeroDocContacto().getValue() + "] Inscripcion Actualizado!");

                } catch (Exception e) {
                    log.error(e, e);
                    messages.add("ERROR I: [" + inscripcion.getStrIdCursoTecsup().getValue() + ":" + inscripcion.getStrNumeroDocContacto().getValue() + "] " + e.getMessage());
                }
            }
